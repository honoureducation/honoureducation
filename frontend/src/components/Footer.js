      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-3">
              <img src={logo} alt="Honour Education Logo" className="h-8 w-auto object-contain" />
              <span className="text-white font-semibold text-sm">Honour Education</span>
            </div>
            <p className="text-slate-400 text-xs mb-4">Multilingual Mapping Assessment</p>
          </div>
          ...
          {/* Social media */}
          <div>
            <h4 className="text-white text-xs font-semibold mb-3">Follow Us</h4>
        ...
        <div className="border-t border-slate-800 mt-8 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-slate-500 text-xs">
            &copy; {year} Honour Education. All rights reserved.
          </p>
