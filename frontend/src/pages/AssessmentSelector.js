...
const ASSESSMENTS = [
  ...
  },
  {
    ...
    color: 'bg-violet-500',
    lightColor: 'bg-violet-50 text-violet-500 border-violet-200',
  ...
  },
  {
    ...
    lightColor: 'bg-emerald-50 text-emerald-500 border-emerald-200',
  ...
  },
  {
    ...
    color: 'bg-pink-500',
    lightColor: 'bg-pink-50 text-pink-500 border-pink-200',
            ...
            <div className="bg-slate-100 p-1.5 rounded-2xl flex items-center gap-1 self-start shadow-inner">
              {['T1', 'T2', 'T3'].map((term) => (
                <button
                  ...
                  className={`px-6 py-2.5 rounded-xl text-sm font-black transition-all duration-300 ${selectedTerm === term
            ...
            >
              ...
              <div className="p-5 xl:p-6">
                ...
                <div className="flex items-start justify-between mb-6">
                  <div className={`w-12 h-12 rounded-2xl flex items-center justify-center border shadow-sm ${a.lightColor}`}>
                    {a.icon}
                  </div>
                ...
                {/* Title */}
                <div className="mb-2">
                  <span className={`text-[10px] font-black ${a.textColor} uppercase tracking-[0.2em]`}>{a.subtitle}</span>
                  <h3 className={`text-xl font-black text-slate-900 ${a.hoverText} transition-colors leading-tight mt-1`}>
                    {a.title}
                  </h3>
                </div>

                {/* Description */}
                <p className="text-sm text-slate-500 leading-relaxed mb-5 opacity-80">{a.desc}</p>

                {/* CTA */}
                <div className="flex items-center justify-between border-t border-slate-50 pt-6">
                  <div className={`flex items-center gap-2 text-xs font-black ${a.textColor} uppercase tracking-widest`}>
                  ...
                  <div className={`w-8 h-8 rounded-full ${a.bgSoft} flex items-center justify-center ${a.hoverBg} group-hover:text-white transition-all duration-300`}>
