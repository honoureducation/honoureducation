...
const OPTIONS = [
  {
    ...
    subtitle: 'Junior',
    desc: 'Reading accuracy with "The Mountain Field" passage. A–E scoring based on decoding, blending, and fluency.',
  ...
  },
  {
    ...
    subtitle: 'Senior',
    desc: 'Advanced reading with "A World Between Worlds" passage. A–E scoring for older learners.',
    color: 'bg-teal-600',
