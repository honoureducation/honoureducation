  ...
  const options = [
    {
      ...
      icon: '📖',
      description: 'Reading accuracy assessment with "The Mountain Field" passage. A-E scoring based on decoding, blending, and fluency.',
    ...
    },
    {
      ...
      icon: '📚',
      description: 'Advanced reading assessment with "A World Between Worlds" passage. A-E scoring for older learners.',
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Reading Assessment</h1>
